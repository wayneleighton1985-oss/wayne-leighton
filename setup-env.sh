...
if [ ! -f ".env.production" ]; then
  ...
  # Create the file with fallback values if environment variables are not set
  cat > .env.production << EOL
NEXT_PUBLIC_TINA_CLIENT_ID=${NEXT_PUBLIC_TINA_CLIENT_ID:-56844d01-3e31-4c3c-b165-956a1f1e0198}
TINA_TOKEN=${TINA_TOKEN:-7a0024bf17443a12d8bf5054e078bd42af60c5e0}
TINA_PUBLIC_IS_LOCAL=${TINA_PUBLIC_IS_LOCAL:-false}
GITHUB_OWNER=${GITHUB_OWNER:-CLAYYO}
GITHUB_REPO=${GITHUB_REPO:-wayne-leighton}
GITHUB_BRANCH=${GITHUB_BRANCH:-main}
GITHUB_PERSONAL_ACCESS_TOKEN=${GITHUB_PERSONAL_ACCESS_TOKEN:-7a0024bf17443a12d8bf5054e078bd42af60c5e0}
EOL
